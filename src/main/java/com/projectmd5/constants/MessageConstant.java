...
public class MessageConstant {
   ...
   public static final String PHONE_EXISTED = "Số điện thoại đã được đăng ký";
   public static final String PASSWORD_NOT_BLANK = "Password không được để trống";
   public static final String PASSWORD_RULE = "Mật khẩu dài tối thiểu 8 ký tự, bao gồm số và chữ thường";
   ...
   public static final String PRICE_NOT_BLANK = "Giá sản phẩm không được để trống";
   public static final String PRICE_RULE = "Giá sản phẩm không được để trống";
